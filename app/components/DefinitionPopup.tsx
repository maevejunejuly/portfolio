    ...
    >
      <div className="mb-2 flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          <p
            lang="te"
            className="m-0 font-telugu text-[26px] leading-[1.2] text-ganula-ink"
          >
            {def.headword}
          </p>
          <p className="m-0 font-mono text-[12px] leading-[1.3] text-ganula-muted">{def.roman}</p>
        </div>
        {onClose && (
          <button
            type="button"
      ...
      <ol className="m-0 mb-2.5 list-decimal pl-4 text-[14px] leading-[1.45] text-ganula-ink">
        {def.senses.map((s, i) => (
